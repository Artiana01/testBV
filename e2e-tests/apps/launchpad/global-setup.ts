/**
 * apps/launchpad/global-setup.ts
 * --------------------------------
 * Exécuté UNE SEULE FOIS avant tous les tests Launchpad BV TECH.
...
const BASE_URL     = process.env.BASE_URL       ?? 'https://staging.bluevaloristech.com';
...
export default async function globalSetup(_config: FullConfig) {
  ...
  console.log('\n🚀  Sessions prêtes. Lancement des tests Launchpad BV TECH...\n');
}
